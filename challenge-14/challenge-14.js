(function (){/*
  ...
  */
  ...
  var name = ['GUS','TA','VO'];
  var x = name.reduce(function (acumulado, atual){
  ...
  */
  ...
  if (numberObject.indexOf({number: 2}) > -1) {
    console.log("Existe um objeto { number: 2 } em numberObjects!");
  } else {
    console.log("Não existe um objeto { number: 2 } em numberObjects :(");
  } // o resultado é false pois nenhum objeto é igual. Cada objeto é alocado em um espaço diferente na memória mesmo tendo
  // o mesmo nome. Assim ao comparálos, o resultado é false 
  ...
  */
  console.log( '\nE buscando a partir do último índice, o { number: 2 } existe?' );
    if (numberObject.lastndexOf({number: 2}, 2) > -1) {
    console.log("Existe um objeto { number: 2 } em numberObjects!");
  } else {
    console.log("Não existe um objeto { number: 2 } em numberObjects :(");
  }
